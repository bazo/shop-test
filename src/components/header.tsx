...
export default function WithSubnavigation({ products }: { products: Product[] }) {
...
const DesktopNav = ({ products }: { products: Product[] }) => {
				...
				<Box key={navItem.label}>
					<Popover trigger={"hover"} placement={"bottom-start"}>
						<PopoverTrigger>
							...
							>
								<RouterLink to={navItem.href as string}>{navItem.label}</RouterLink>
							</Link>
						</PopoverTrigger>
